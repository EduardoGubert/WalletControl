...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "WalletControl.MauiBlazor.dll" comes first in this list. */
		"WalletControl.MauiBlazor.dll",
		...
		"Microsoft.Maui.Controls.resources.dll",
		"Microsoft.Maui.Controls.resources.dll",
		"WalletControl.Application.dll",
		"WalletControl.Domain.dll",
		"WalletControl.Infrastructure.dll",
